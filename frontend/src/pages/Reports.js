...
const TABS = ['Summary', 'Sales', 'Purchases', 'Expenses', 'Top Products'];
        ...
        <div>
          <div className="stat-grid" style={{marginBottom:'24px'}}>
            <div className="stat-card green">
              ...
              <div className="value">{fmt(data.sales?.total)}</div>
              <div className="sub">{data.sales?.count} invoices</div>
            </div>
            <div className="stat-card blue">
              <div className="label">Collected</div>
              <div className="value">{fmt(data.sales?.collected)}</div>
              <div className="sub">Cash received</div>
            </div>
            <div className="stat-card yellow">
              <div className="label">Outstanding</div>
              <div className="value">{fmt(data.sales?.due)}</div>
              <div className="sub">Yet to collect</div>
            </div>
            <div className="stat-card red">
              <div className="label">Total Expenses</div>
              <div className="value">{fmt(data.expenses?.total)}</div>
              <div className="sub">{data.expenses?.count} entries</div>
            </div>
            <div className="stat-card blue">
              <div className="label">Total Purchases</div>
              <div className="value">{fmt(data.purchases?.total)}</div>
              <div className="sub">{data.purchases?.count} orders</div>
            </div>
            <div className="stat-card green">
              <div className="label">Gross Profit</div>
              <div className="value" style={{color: data.profit?.gross >= 0 ? 'var(--accent-green)' : 'var(--accent-red)'}}>
            ...
            <div className={`stat-card ${data.profit?.net >= 0 ? 'green' : 'red'}`}>
              ...
              <div className="value" style={{color: data.profit?.net >= 0 ? 'var(--accent-green)' : 'var(--accent-red)'}}>
                {fmt(data.profit?.net)}
              </div>
            ...
            <div className="card" style={{padding:'1rem'}}>
              ...
              <div style={{background:'#f1f2f6',borderRadius:'8px',height:'24px',overflow:'hidden'}}>
                <div style={{
                  ...
                  borderRadius:'8px',transition:'width .3s',
            ...
            <table>
              ...
              <tbody>
                {(Array.isArray(data) ? data : []).length === 0 ? (
                  <tr><td colSpan={8}><div className="empty-state">No sales in this period</div></td></tr>
      ...
      {data && tab === 'Purchases' && (
        <div className="card">
          ...
          <div className="table-wrapper">
            <table>
              <thead>
                <tr><th>Purchase #</th><th>Supplier</th><th>Date</th><th>Items</th><th>Total</th><th>Paid</th><th>Due</th><th>Status</th></tr>
              </thead>
              <tbody>
                {(Array.isArray(data) ? data : []).length === 0 ? (
                  <tr><td colSpan={8}><div className="empty-state">No purchases in this period</div></td></tr>
      ...
      {data && tab === 'Expenses' && (
        <div className="card">
          ...
          <div className="table-wrapper">
            <table>
              <thead>
                <tr><th>Date</th><th>Category</th><th>Description</th><th>Payee</th><th>Method</th><th>Amount</th></tr>
              </thead>
              <tbody>
                {(Array.isArray(data) ? data : []).length === 0 ? (
                  <tr><td colSpan={6}><div className="empty-state">No expenses in this period</div></td></tr>
      ...
      {data && tab === 'Top Products' && (
        <div className="card">
          <div className="table-wrapper">
            <table>
              <thead>
                <tr><th>#</th><th>Product</th><th>Units Sold</th><th>Revenue</th><th>Cost</th><th>Profit</th><th>Margin</th></tr>
              </thead>
              <tbody>
                {(Array.isArray(data) ? data : []).length === 0 ? (
                  <tr><td colSpan={7}><div className="empty-state">No sales in this period</div></td></tr>
