                    ...
                    {(viewPurchase.items || []).length === 0 ? (
                      ...
                      <tr key={i} style={{borderBottom:'1px solid var(--border)'}}>
                        <td style={{padding:'8px 0'}}>
                          <strong>{item.brand} {item.product_name}</strong>
                          {item.model && <span style={{color:'var(--text-muted)',fontSize:'.8rem'}}> — {item.model}</span>}
                        </td>
            ...
            <div className="modal-body">
              ...
              <div style={{padding:'8px 12px',borderRadius:'6px',marginBottom:'1rem',fontSize:'.85rem',
                ...
                {form.payment_type==='cash'
                  ...
                  : '⏳ Credit Purchase — unpaid amount added to supplier balance'}
              </div>
