...
export default function Layout({ children, user, onLogout }) {
  ...
  const navItems = [
    ...
    { path: '/expenses',      label: 'Expenses',      icon: ExpensesIcon,     roles: ['admin','staff','accountant'] },
    { path: '/cheques',       label: 'Cheques',       icon: ChequesIcon,      roles: ['admin','staff','accountant'] },
    { path: '/cash-register', label: 'Cash Register', icon: CashIcon,         roles: ['admin','staff','accountant'] },
    { path: '/transfers',     label: 'Transfers',     icon: TransfersIcon,    roles: ['admin','staff','accountant'] },
    { path: '/obligations',   label: 'Obligations',   icon: ObligationsIcon,  roles: ['admin','staff','accountant'] },
    { path: '/finance',       label: 'Finance',       icon: FinanceIcon,      roles: ['admin','staff','accountant'] },
    { path: '/user-log',      label: 'User Log',      icon: UserLogIcon,      roles: ['admin'] },
    { path: '/reports',       label: 'Reports',       icon: ReportsIcon,      roles: ['admin','staff','accountant'] },
    { path: '/attendance',    label: 'Attendance',    icon: AttendanceIcon,   roles: ['admin','staff','accountant'] },
    { path: '/stock-count',   label: 'Stock Count',   icon: StockCountIcon,   roles: ['admin','staff','accountant'] },
