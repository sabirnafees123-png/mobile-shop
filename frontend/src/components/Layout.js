...
export default function Layout({ children, user, onLogout }) {
  ...
  const navItems = [
    { path: '/',              label: 'Dashboard',     icon: DashboardIcon,    roles: ['admin','accountant'] },
    ...
    { path: '/transfers',     label: 'Transfers',     icon: TransfersIcon,    roles: ['admin','accountant'] },
    ...
    { path: '/attendance',    label: 'Attendance',    icon: AttendanceIcon,   roles: ['admin','accountant'] },
